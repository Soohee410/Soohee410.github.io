...
PDP에서는 이를 이용합니다. 관심 있는 변수들을 $X_S$, 그 외의 변수들을 $X_C$라고 할 때, $X_S$의 Partial Dependence Function은 다음과 같이 계산됩니다.
...
<img src="/assets/iml4_3.PNG" width='400px'>

나머지 변수들도 나타내보면 다음과 같습니다.

- **education.num**
확실히 교육 수준이 높아질수록, 1로 분류될 확률이 높은 걸 확인할 수 있습니다.
<img src="/assets/iml4_4.PNG" width='500px'>

- **capital.gain**
한편, capital.gain의 경우, 3000에서 한번 치솟고, 그 뒤에 4000 이상부터 1로 분류될 확률이 높아집니다. 연속형 변수이기 때문에, PDP를 구하는데 시간이 위 두 변수들에 비해 오래 걸렸습니다.
<img src="/assets/iml4_5.PNG" width='600px'>

이렇게, 중요하게 뽑힌 변수들 각각에 대해, Target과 어떤 영향이 있는지 파악해 보았습니다. 한편, 처음에 언급했듯이, 관심 변수는 꼭 하나 말고 2개까지도 가능합니다! marital.status와 education.num의 **Two-way PDP**를 한번 그려보면 다음과 같습니다. x축이 marital.status, y축이 education.num인데, 교육수준이 높고 배우자와 함께 살고 있는 사람일수록 연봉이 $50,000이상일 확률이 높습니다. 그런데 이 확률 값이, 두 변수 개별 플랏에서 확인했던 최대치보다도 높습니다! 즉, 두 변수가 모이니까 1로 분류될 확률이 더욱 높아졌네요.
