...
date:   2020-01-15
image: '/assets/img/linear_main3.png'
tags: [Linear Algebra]
use_math: true
---
...
$$\begin{aligned} \boldsymbol x\in Nul(A) &\iff A\boldsymbol x=0 \\ &\iff \boldsymbol x ⊥Row(A) \iff \boldsymbol x \in Row(A)^⊥ \end{aligned}$$
