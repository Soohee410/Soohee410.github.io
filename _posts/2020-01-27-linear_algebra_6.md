...
<img src="/assets/least1.png" width="600px">
...
$\qquad\qquad\qquad \lVert b-A\hat x\rVert≤\lVert b-Ax\rVert,for\space all\space x\in \mathbb R^n $
...
<img src="/assets/least2.png" width="400px">
...
$$\qquad\qquad\qquad\qquad \hat x = R^{-1}Q^{\intercal}b$$
