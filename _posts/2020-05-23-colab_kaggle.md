---
layout: post
title: "[Google Colab] Kaggle 연동, 코랩에서 Kaggle dataset 검색 및 다운로드"
tags: [삽질 기록]
use_math: true
---
...
<img src='/assets/colabkaggle6.PNG' width='650px'>

이제 구글 코랩으로 돌아와서 kaggle을 설치하고, kaggle.json 파일을 업로드합니다.
<img src='/assets/colabkaggle1.PNG' width='650px'>

다음과 같이 코드를 입력합니다. 이로써 Kaggle 연동 및 데이터셋을 다운로드하기 위한 세팅을 모두 마무리한 것입니다.
<img src='/assets/colabkaggle2.PNG' width='600px'>
...
<img src='/assets/colabkaggle3.PNG' width='650px'>
...
<img src='/assets/colabkaggle4.PNG' width='650px'>
...
<img src='/assets/colabkaggle5.PNG' width='650px'>
